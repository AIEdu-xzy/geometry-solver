...
class AlternateAngleEquality(Theorem):
    ...
    def index(self, indexer: Indexer):
        """Find alternate angles from parallel relationship."""
        ret = []
