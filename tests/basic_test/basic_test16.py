...
def get_problem():
    ...
    conditions.append(AttributeValue(angle_b, angle=60))
    conditions.append(AttributeValue(angle_c, angle=60))
    conditions.append(AttributeValue(line_bc, length=1))
